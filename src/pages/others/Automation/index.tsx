...
import { FiSearch, FiPlus, FiClock, FiActivity, FiPower, FiMoreVertical } from 'react-icons/fi';
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-white min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-800">Automation Workflows</h1>
          <p className="text-gray-600 mt-1 text-sm">Manage your automated workflows with ease</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-white p-4 rounded-xl border border-pink-200 shadow-md transition-all duration-200 hover:-translate-y-1 hover:shadow-lg">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-medium text-gray-600">Total Automations</h3>
